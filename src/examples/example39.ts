...
import { ExtensionName, Formatters, HybridSelectionModelOption, type Column, type GridOption } from '@slickgrid-universal/common';
...
export default class Example01 {
  ...
  attached() {
    ...
    this._bindingEventService.bind(document.querySelector('.grid39-1') as HTMLDivElement, 'onclick', this.handleOnCellClicked.bind(this));
  ...
  changeDataset2() {
    ...
    setTimeout(() => {
      this.sgb2.dataset = this.mockMasterData();
