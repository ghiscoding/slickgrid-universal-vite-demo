  ...
  initializeGrid() {
    ...
    this.gridOptions = {
      ...
      customFooterOptions: {
        ...
        leftFooterText: 'Grid created with <a href="https://github.com/slickgrid-stellar/slickgrid-universal" target="_blank">Slickgrid-Universal</a> <i class="mdi mdi-github"></i>',
      },
