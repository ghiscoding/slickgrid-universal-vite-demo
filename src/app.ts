...
export class App {
  ...
  attached() {
    ...
    if (decodedCookie !== 'serve-mode=cypress') {
      ...
      ghStarLinkElm.href = 'https://github.com/slickclub/slickgrid-universal';
      const imgStarElm = document.createElement('img');
      imgStarElm.src = 'https://img.shields.io/github/stars/slickclub/slickgrid-universal?style=social';
